    ...
    <!-- PAGE CONTENT BEGINS -->
      <div class="widget-body">
        <div class="widget-main no-padding">
          ...
          <form class="form-horizontal" method="post" id="form-default" action="<?php echo site_url('reference/Global_parameter/process?flag='.$flag_string.'')?>" enctype="multipart/form-data">
              <br>
              <!-- hidden form -->
              ...
              <div class="form-actions center">
                <a onclick="getMenu('reference/Global_parameter?flag=<?php echo $flag_string?>')" href="#" class="btn btn-sm btn-success">
          ...
          $.ajax({
            ...
            complete: function(xhr) {     
              ...
              if(jsonResponse.status === 200){
                ...
                $('#page-area-content').load('reference/Global_parameter?flag='+$('#flag_string').val()+'&_=' + (new Date()).getTime());
              }else{
