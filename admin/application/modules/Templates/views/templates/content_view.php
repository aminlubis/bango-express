...
<html lang="en">
  ...
  <body class="no-skin">
    ...
    <div id="navbar" class="navbar navbar-default" style="background: linear-gradient(45deg, #fd0101, #fd6f00);">
      ...
      <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
          ...
          <a href="#" class="navbar-brand">
            <small>
              <img src="<?php echo base_url().'assets/images/Bango_Logo_Full_White.png'?>" height="40px" style="margin: -54px -23px -56px">
