...
<div class="page-header">
    ...
    <div class="col-sm-12">
        <form class="form-horizontal" method="post" id="form-default" action="<?php echo site_url('receiptment/T_receiptment/process')?>" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6 no-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" value="" name="receipt_by">
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="form-actions center">
            <a onclick="getMenu('receiptment/T_receiptment')" href="#" class="btn btn-sm btn-success">
      ...
      $('#form-default').ajaxForm({
        ...
        complete: function(xhr) {     
          ...
          if(jsonResponse.status === 200){
            ...
            $('#page-area-content').load('receiptment/T_receiptment');
          }else{
