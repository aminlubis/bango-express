            ...
            <div class="step-content pos-rel">
                ...
                <input type="hidden" name="id" value="<?php echo isset($value->id)?$value->id:''?>">
                    <div class="step-pane active" data-step="1">
                        ...
                        <div class="row">
                            <div class="col-md-12 input-inline">
                                ...
                                <input class="form-control input-mask-date" type="text" id="autocomplete" placeholder="Enter your address" onFocus="geolocate()">
                                <!-- hidden -->
                                <input type="hidden" class="form-control" id="longitude" name="longitude" placeholder="longitude" value="" disabled="true">
                                <input type="hidden" class="form-control" id="latitude" name="latitude" placeholder="latitude" value="" disabled="true">
                            </div>
                            ...
                            <div class="col-md-3 input-inline">
                                ...
                                <input class="form-control" id="administrative_area_level_2" type="text" value="<?php echo isset($value)?$value->nama_kab:'' ?>"/>
                            ...
                            <div class="col-md-3 input-inline">
                                ...
                                <input class="form-control" id="administrative_area_level_1" disabled type="text" value="<?php echo isset($value)?$value->nama_prov:'' ?>" />
                            ...
                            <div class="col-md-2 input-inline">
                                ...
                                <input name="postal_code_pengirim" id="postal_code_pengirim" value="<?php echo isset($value->postal_code_pengirim)?$value->postal_code_pengirim:''?>"  class="form-control" type="text">
                            </div>
                        </div>
                    ...
                    <div class="step-pane" data-step="2">
                        ...
                        <div class="row">
                            <div class="col-md-12 input-inline">
                                <label for="form-field-11">Deliver Location *</label>
                                <input class="form-control input-mask-date" type="text" id="autocomplete" placeholder="Enter your address" onFocus="geolocate()">
                                <!-- hidden -->
                                <input type="hidden" class="form-control" id="longitude" name="longitude" placeholder="longitude" value="" disabled="true">
                                <input type="hidden" class="form-control" id="latitude" name="latitude" placeholder="latitude" value="" disabled="true">
                            ...
                            <div class="col-md-12 input-inline">
                                <label for="form-field-11">Apartment, unit, suite, or floor #</label>
                                <input name="address_detail_penerima" id="address_detail_penerima" value="<?php echo isset($value->address_detail)?$value->address_detail:''?>"  class="form-control" type="text">
                            </div>
                            ...
                            <div class="col-md-2 input-inline">
                                <label for="form-field-11">Postal Code</label>
                                <input name="postal_code_penerima" id="postal_code_penerima" value="<?php echo isset($value->postal_code_penerima)?$value->postal_code_penerima:''?>"  class="form-control" type="text">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-8 input-inline">
                    ...
                    <div class="step-pane" data-step="4">
                        ...
                        <div class="row">
                            <div class="col-md-4 input-inline">
                                ...
                                <input name="tarif" id="tarif" value="<?php echo isset($value)?$value->tarif:''?>"  class="form-control format_number" type="hidden">
                            </div>
                        </div>
