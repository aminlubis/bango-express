...
class T_receipt_history_model extends CI_Model {
	...
	private function _main_query(){
		...
		$this->db->join('t_receiptment', 't_receiptment.receipt_id=t_order.receipt_id','left');
	...
	private function _get_datatables_query()
	{
		...
		$this->_main_query();
		$this->db->where('t_order.receipt_id is not null');
