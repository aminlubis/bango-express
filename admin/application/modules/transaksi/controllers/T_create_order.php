...
class T_create_order extends MX_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        /*breadcrumb default*/
        $this->breadcrumbs->push('Index', 'transaksi/T_create_order');
    ...
    public function get_data()
    {
        ...
        foreach ($list as $row_list) {
            ...
            //                 <li>'.$this->authuser->show_button('transaksi/T_create_order','R',$row_list->id,67).'</li>
            //                 <li>'.$this->authuser->show_button('transaksi/T_create_order','U',$row_list->id,67).'</li>
            //                 <li>'.$this->authuser->show_button('transaksi/T_create_order','D',$row_list->id,6).'</li>
            //             </ul>
            //           </div></div>';
            ...
            if($row_list->pickup_log_id == null){
                ...
                '.$this->authuser->show_button('transaksi/T_create_order','U',$row_list->id,68).'
                '.$this->authuser->show_button('transaksi/T_create_order','D',$row_list->id,9).'
                <a href="#" title="cetak resi" class="label label-inverse" onclick="PopupCenter('."'transaksi/T_create_order/preview_resi/".$row_list->id."'".','."'CETAK RESI'".', 500, 450)"><i class="fa fa-print"></i></a>
                <a title="cancel order" href="#" class="label label-warning" onclick="PopupCenter('."'transaksi/T_create_order/preview_resi/".$row_list->id."'".','."'CETAK RESI'".', 500, 450)"><i class="fa fa-exclamation-triangle"></i></a>
                </div>';
            }else{
                $row[] = '<div class="center">
                <a href="#" title="cetak resi" class="label label-inverse" onclick="PopupCenter('."'transaksi/T_create_order/preview_resi/".$row_list->id."'".','."'CETAK RESI'".', 500, 450)"><i class="fa fa-print"></i></a>
