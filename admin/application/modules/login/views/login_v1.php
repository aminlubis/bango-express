  ...
  <body class="fixed-header   ">
    ...
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <?php
          $arr_cover = array('12.png'); 
              shuffle($arr_cover);
        ?>
        <img src="<?php echo base_url().'assets/login/img/cover/'.array_shift($arr_cover).''?>" data-src="<?php echo base_url().'assets/login/img/cover/'.array_shift($arr_cover).''?>" data-src-retina="<?php echo base_url().'assets/login/img/cover/'.array_shift($arr_cover).''?>" alt="" class="" width="100%">
        <!-- END Background Pic-->
      ...
      <div class="col-md-4">
      <div class="login-container bg-white col-md-4">
