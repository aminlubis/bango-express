...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8" />
    <title>BanGo Express - Sameday Service</title>

    <meta name="description" content="BanGo Express - Dashboard Admin Login Page" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
    <meta name="BanGo Express" content="yes">
    <meta name="BanGo Express" content="yes">
    <meta name="BanGo Express" content="default">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/images/Bango_Logo_Icon.png">
        ...
        <div class="row">
          ...
          <div class="col-sm-10 col-sm-offset-1">
            <div class="login-container" style="padding-top: 100px">
              ...
              <div class="center">
                <h1>
                  <img src="<?php echo PATH_IMG_DEFAULT.$profile_form->app_logo?>" width="100%">
                </h1>
                <!-- <h3 class="dark" id="id-text" style="font-size: 14px; margin-top: -5px; color: #213a6d  !important; font-weight: bold"><?php echo $profile_form->app_name?><br><small></small></h3> -->
              ...
              <div class="position-relative">
                <div id="login-box" class="login-box visible widget-box no-border">
                  <div class="widget-body">
                    ...
                    <div class="toolbar clearfix" style="background: linear-gradient(45deg, #fd0101, #fd6f00) !important">
