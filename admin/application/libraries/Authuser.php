...
final Class Authuser
{
    ...
    function update_button($url, $id, $code_style)
    {
        ...
        switch ($code) {
            ...
            case 'U68':
                ...
                $Query_String = explode("&", explode("?", $_SERVER['REQUEST_URI'])[1]);
                $param_string = isset($Query_String[0]) ? $Query_String[0] : '';
                $btn = '<a href="#" class="label label-success" onclick="getMenu(' . "'" . $link . '/form/' . $id . '?' . $param_string . '' . "'" . ')" title="Update"><i class="fa fa-edit"></i></a>';
                break;
    ...
    function delete_button($url, $id, $code_style)
    {
        ...
        switch ($code) {
            ...
            case 'D9':
                # code...
                $btn = '<a href="#" class="label label-danger" ionclick="delete_data(' . "'" . $id . "'" . ')"><i class="ace-icon fa fa-trash-o"></i></a>';
                break;
